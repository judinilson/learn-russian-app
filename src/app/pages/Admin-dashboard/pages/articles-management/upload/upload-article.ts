...
export class UploadArticleTaskComponent implements OnInit {
        ...
        if (
          ...
          setTimeout(() => {
            ...
            this.uploadArticleForm = this.formBuilder.group({
              ...
              description: [
                this.receiveSelectedData.description,
                [Validators.required],
              ],
              category:
  ...
  uploadArticleContent(imgurl) {
    ...
    this.contentService
      ...
      .subscribe(
        (res) => {
          this.alertService.openSweetAlertToast("success", "Успешно добавлен");
          this.backwardbtn();
        },
        (error) => {
  ...
  updateArticleContentFunc(imageUpdate, catg) {
    ...
    var articleJsonDoc = toHTML(this.uploadform.article.value, schema);
    this.contentService
      .updateArticleContent(this.receiveSelectedData.id, {
      ...
      .subscribe(
        (res) => {
          ...
          this.backwardbtn();
          this.alertService.openSweetAlertToast("success", "Успешно обновлено");
        },
        (error) => {
          this.loading = false;
          //this.error = error;
